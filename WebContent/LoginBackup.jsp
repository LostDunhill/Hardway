			...
			<div class="row">
				<div class="form-group col-md-6">
					<label for="cdcpf">CPF:</label> <input type="text"
						class="form-control" name="cdcpf" id="cdcpf" required
						maxlength="11" placeholder="Digite seu CPF" />
				</div>
				<div class="form-group col-md-6">
					<label for="cdrg">RG:</label> <input type="text"
						class="form-control" name="cdrg" id="cdrg" required maxlength="11"
						placeholder="Digite seu RG" />
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-12">
					<label for="cdemail">E-mail:</label> <input type="email"
